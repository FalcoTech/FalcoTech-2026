...
public final class Constants {
  ...
  public static final class CurrentLimits {
    ...
    public static final Current SWERVE_DRIVE_SUPPLY = Amps.of(40);
    // Swerve Drive boost mode (Pilot.b() held)
    public static final Current SWERVE_DRIVE_BOOST_STATOR = Amps.of(100);
    public static final Current SWERVE_DRIVE_BOOST_SUPPLY = Amps.of(80);
    ...
    public static final Current INTAKE_ROLLER_SMART = Amps.of(50);
    // Feeder (SparkMax / NEO)
